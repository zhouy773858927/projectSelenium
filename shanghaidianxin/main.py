...
from shanghaidianxin import login, Jietu
...
class Main(unittest.TestCase):
    def setUp(self):
        ...
        self.url = "http://192.168.0.201:18081/saferycom/login.do"
    ...
    def test_oneJH(self):
        ...
        element = WebDriverWait(driver, 10).until(
            lambda driver: self.driver.find_element_by_xpath("/html/body/div/div[2]/div[2]/ul/li[1]/a"))
        element.click()
        element = WebDriverWait(driver, 10).until(
            lambda driver: self.driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[2]/div[6]/div[1]/div[2]/a"))
        element.click()
        time.sleep(1)
        #一级稽核界面
        element = WebDriverWait(driver, 10, 0.5).until(lambda driver: self.driver.find_element_by_xpath("//*[@id='一级稽核']"))
        print(driver.find_element_by_xpath("//*[@id='一级稽核']").text)
        ...
        element.send_keys("1512457046445")
        # js = 'document.getElementsByClassName("l-btn-left")[0].click();'
        # driver.execute_script( js)
        time.sleep(5)
        #搜索按钮
        element = WebDriverWait(driver, 10, 1).until(
            lambda driver: self.driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div[1]/div[1]/a[2]/span/span"))
        element.click()
        #调用截图方法
        Jietu.jietu(self)
        time.sleep(1)
        ...
        element = WebDriverWait(driver, 10).until(lambda driver: self.driver.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div[2]/table/tbody/tr/td[13]/div/a"))
        element.click()
        ...
        for handle1 in allhandles:
            if handle1 != oldhandle:
                ...
                #稽核通过按钮
                element = WebDriverWait(driver, 10).until(
                    lambda driver: self.driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[6]/a[1]/span/span"))
                element.click()
